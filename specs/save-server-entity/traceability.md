...
| FR-SAVE-027/033 | Direct final write; partial failure visible | publication-v1, ADR-018 | P-SAVE-002 | Short-write/disk/flush fault matrix |
...
| Parent FR-041/DR-014 | Explicit File Datasource path authoring; current save read limitation | parent declaration contract + save reverse manifest | Y-SAVE-002 | Current non-exportable fixture |
| QR-SAVE-001/002 | Determinism and immediate one-file lint validity | canonical + validation contracts | Y-SAVE-002/V-SAVE-003 | Repeat/lint tests |
